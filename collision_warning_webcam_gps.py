...
Zone_10 = Polygon([(521, 719), (652, 601), (735, 600), (800, 719)])  #shapely
Zone_20 = Polygon([(521, 719), (668, 579), (724, 581), (800, 719)])  #shapely
Zone_30 = Polygon([(521, 719), (681, 565), (715, 564), (800, 719)])  #shapely
Zone_40 = Polygon([(521, 719), (687, 556), (713, 557), (800, 719)])  #shapely
Zone_50 = Polygon([(521, 719), (692, 540), (705, 540), (800, 719)])  #shapely
# Zone_60 = Polygon([(850, 1079), (1314, 734), (1456, 738), (1620, 1079)])  #shapely

Default_zone1 = Zone_10 # Polygon([(640, 564), (559, 715), (937, 704), (708, 563)])# Zone_30
Default_zone2 = Zone_30 # Polygon([(649, 533), (565, 715), (919, 707), (677, 533)])# Zone_60
...
while True:
    ...
    # print(i)
    cv2.imwrite('/home/pi/tflite1/AI_Buddy_Field_Test/7_inch_HDMI_LCDB/15th_June_2022/Results/ADAS/Test19/Frame'+str(frame_num).zfill(4)+'.jpg', frame)
